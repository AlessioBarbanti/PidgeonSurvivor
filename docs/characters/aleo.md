...
La direzione visuale corrente di Aleo è quella del rework approvato il 28
agosto 2026 e resta una caricatura pixel-art coerente con il resto del cast.
...
[`docs/archive/generation-prompts-and-references.md`](../archive/generation-prompts-and-references.md#aleo--prompt-riutilizzabile),
...
- `docs/characters/references/aleo/source-01.png`, `source-02.png` — 2 file,
  ruolo `subject reference`, fuori da import/export. Per il busto Player
  PS-068 `poses.png` è rimasto dominante per proporzioni, identità di gioco e
  stile.
