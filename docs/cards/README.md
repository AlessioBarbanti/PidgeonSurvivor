...
| [PS-170](./4_to_test/PS-170-aggiungi-selettore-difficolta-prima-della-run.md) | Aggiungi un selettore della difficoltà prima della run | feat | gameplay | IN VERIFICA | media | PS-157, PS-158, PS-161 |
...
| [PS-194](./4_to_test/PS-194-movimento-errante-copia-fantasma-piccione-malvagio.md) | Fai vagare la copia fantasma dello specchio invece di farla orbitare in cerchio fisso | ux | gameplay | IN VERIFICA | media | — |
...
| [PS-203](./4_to_test/PS-203-tetto-sei-power-up-diversi.md) | Limita a sei i power up diversi di una run | feat | gameplay | IN VERIFICA | media | — |
| [PS-204](./4_to_test/PS-204-mostra-power-up-presi-in-hud.md) | Mostra nell'HUD i power up presi e il loro rango | ux | ui | IN VERIFICA | media | PS-203 |
...
| [PS-207](./4_to_test/PS-207-attizzatoio-si-arroventa-con-la-distanza.md) | Fai arroventare l'Attizzatoio di Lollo, che più va lontano più fa male | fix | gameplay | IN VERIFICA | media | PS-200 |
