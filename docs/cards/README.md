...
| [PS-175](./4_to_test/PS-175-residuo-non-determinismo-separazione-nemici-full.md) | Diagnostica il residuo di non-determinismo nella separazione nemici su Full | fix | gameplay | IN VERIFICA | bassa | PS-171, PS-174 |
...
| [PS-177](./4_to_test/PS-177-non-determinismo-full-proiettile-tiratore.md) | Diagnostica il proiettile del Tiratore espulso in modo non deterministico su Full | fix | gameplay | IN VERIFICA | media | — |
| [PS-178](./3_in_sprint/PS-178-lag-al-minuto-2-arrivo-primo-boss.md) | Diagnostica il lag riportato al minuto 2 (coincide con l'arrivo del primo Boss) | perf | gameplay | IN CORSO | alta | — |
