...
`PS-007` ([docs/cards/4_to_test/PS-007-impedire-run-AFK-lategame.md](./cards/5_completed/PS-007-impedire-run-AFK-lategame.md),
...
([docs/cards/4_to_test/PS-008-eventi-di-ondata.md](./cards/5_completed/PS-008-eventi-di-ondata.md),
