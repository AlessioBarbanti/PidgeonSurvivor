...
Arma (PS-202, in prova) — **Coperchio**: la prima arma in mischia del cast. A ogni colpo Magno fa roteare un coperchio da barbecue lungo un arco di circa 150° centrato nella direzione in cui sta andando, come lo scatto di Bea; il coperchio gli resta agganciato mentre si muove e spazza fino a cinque nemici per fendente. In automatico parte solo quando un nemico è davanti a lui e a portata (~150 px), così non gira nel vuoto e il colpo è pronto quando il nemico arriva; i nemici alle spalle vanno affrontati voltandosi. In manuale conta la mira del giocatore. Ritmo lentissimo (1 fendente/s): per colpire, Magno deve entrare nella mischia, esattamente dove la sua passiva gli chiede di andare. Non respinge, perché la spinta è dell'Onda d'Urto Tellurica. Sostituisce la Carbonella di PS-198.
...
Arma (PS-200, PS-207 in prova) — **Attizzatoio**: un colpo sottile che parte piano, prende velocità man mano che va, arrivando lontanissimo, e **si arroventa** mentre vola. Appena partito è una brace scura e fa il 70% del danno; dopo 500 px è bianco rovente e fa il 150%, con una scia che si allunga con la velocità. Premia chi tiene i nemici a distanza. I tre valori stanno in `data/weapons/attizzatoio.tres`. È un'eco di Iperfocus ADHD, non un suo doppione: la passiva cambia il ritmo di *Lollo*, l'arma cambia la velocità del *colpo* lungo il proprio volo, e le due grandezze non si sommano.
...
Boss: Evil Marghe — Signature *Reggaeton time!*: genera un clone ballerino distinguibile dal Boss reale, che l'auto-targeting del Player può preferire mentre Marghe continua a usare i propri pattern. Il clone spara periodicamente al Player (stesso schema telegraph→proiettile dei nemici a distanza) e resta fermo; se il Player non lo elimina prima che la Signature si rielegga, un altro clone si aggiunge invece di sostituirlo, fino a un tetto massimo (PS-174).
