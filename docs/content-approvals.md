...
| Icone passive del roster B18W | Integrate; gate percettivo aperto | Otto PNG raster dedicati (Magno più sette master RGBA forniti dal proprietario) sostituiscono il fallback al ritratto nel kit. Prompt, origine, trasformazioni e hash sono in `assets/art/icons/passives/ASSET-MANIFEST.md`; resta il confronto percettivo fisico |
