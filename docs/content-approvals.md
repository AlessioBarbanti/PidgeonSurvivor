...
| Archetipi speciali B49 | Approvati e integrati | Sciamatore, corazzato, divisore, tiratore e frammento del divisore usano strip runtime dedicate con master, prompt, trasformazioni e hash nei manifest locali. Il candidato è accettato operativamente il 30 agosto 2026 senza nuova prova percettiva su device |
...
| Refresh decal runtime B18M | Approvato e integrato | Nove decal ImageGen sostituiscono nel mondo gli emblemi HUD e seguono posizione, raggio e fase degli effetti. Il candidato del 29 agosto è accettato operativamente il 30 agosto 2026 senza nuova evidenza fisica; contratti gameplay e timing restano invariati |
...
| Icone forme d'attacco B41 | Approvate e integrate | Su richiesta del proprietario i tre badge geometrici sono sostituiti da soggetti da griglia: spiedino con tre bocconi per Colpo Perforante, doppia Costina per Raffica Doppia e Coppa per Esplosione Finale. Master ImageGen, trasformazioni e hash sono nel manifest upgrade; ID, copy ed effetti gameplay restano invariati. Candidato accettato operativamente il 30 agosto 2026 senza nuova evidenza percettiva |
| Fondale e logo welcome B18O | Refresh approvato e integrato | Il refresh del 28 agosto usa gli otto master B18U, derivati da riferimenti fotografici forniti e autorizzati dal proprietario, per riallineare il cast della welcome alle identità correnti. Restano esattamente otto caricature pixel-art ai bordi, senza UI raster e con centro protetto. Il master HD e la versione precedente sono esclusi da import/export; prompt, origine, crop e SHA-256 sono nel manifest dedicato. Candidato accettato operativamente il 30 agosto 2026 |
...
| Sprite Player B18U | Approvati e integrati | Le otto identità pixel-art correnti sono conservate come master in `assets/art/characters/players/hd/` e derivate da riferimenti fotografici forniti e autorizzati dal proprietario. Le strisce runtime, le sorgenti HD escluse dagli export, prompt, trasformazioni, licenza e SHA-256 sono nel manifest dedicato |
...
| Musica di sottofondo B29 | Integrata e accettata operativamente | `Super Wreck Roadway (loop)` di Umplix, da OpenGameArt, CC0 1.0 Universal. La fonte pubblica espone il loop WAV; il proprietario ha fornito l'OGG runtime. URL, licenza, data di acquisizione, trasformazione dichiarata e SHA-256 sono in `assets/audio/third_party/super_wreck_roadway_loop.MANIFEST.md`; il credito volontario è in `docs/credits.md`. Accettazione del 30 agosto 2026 senza nuovo ascolto registrato |
| Welcome B32 | Riuso nativo approvato | `GIOCA` riusa esclusivamente `character_select_cta_base.png`, già approvata per B18W; testo, ingranaggio, focus e pressed sono controlli Godot nativi. Non entra alcun nuovo raster né nuovo contenuto personale. Accettato operativamente il 30 agosto 2026 |
| Proiettili PS-002 | Approvati e integrati | Brace dorata alleata e piuma-punta magenta ostile sostituiscono i cerchi procedurali; master, palette, derivazioni e hash sono nel manifest VFX. Candidato accettato operativamente il 30 agosto 2026 senza nuova verifica percettiva |
