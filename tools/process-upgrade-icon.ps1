    ...
    try {
        ...
        try {
            ...
            $graphics.DrawImage(
                ...
                (New-Object System.Drawing.Rectangle($left, $top, $squareSize, $squareSize)),
...
Write-Output "UPGRADE_ICON_RUNTIME_OK path=$($result.FullName) bytes=$($result.Length) sha256=$($hash.Hash)"
